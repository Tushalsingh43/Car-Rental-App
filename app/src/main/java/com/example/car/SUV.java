...
public class SUV extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        s1 = findViewById(R.id.su1);
        s2 = findViewById(R.id.su2);
        s3 = findViewById(R.id.su3);
        s4 = findViewById(R.id.su4);
        s5 = findViewById(R.id.su5);
        s6 = findViewById(R.id.su6);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(SUV.this,Details.class);
